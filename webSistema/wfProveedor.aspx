<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfProveedor.aspx.vb" Inherits="webSistema.wfProveedor" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="text-center mt-4">
            <p style="font-size:40px;"><strong>PROOVEDORES</strong></p>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="listado" style="overflow-x: auto; max-width: 100%;">
                        <asp:GridView ID="DgvListado" runat="server" AllowPaging="true" PageSize="8"
