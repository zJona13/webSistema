<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfVenta.aspx.vb" Inherits="webSistema.wfVenta" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="text-center mt-4">
            <p style="font-size:40px;"><strong>VENTAS</strong></p>
        </div>
                    ...
                    <div class="formulario p-3 rounded" style="background-color: #f9f9f9; border: 1px solid #ddd;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group" id="cliente">
                                ...
                                <asp:Button ID="BtnBuscarCliente" runat="server" CssClass="btn btn-secondary" Text="..." />
                            </div>
