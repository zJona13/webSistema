<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfCategoria.aspx.vb" Inherits="webSistema.wfCategoria" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="text-center mt-4">
            <p style="font-size:40px;"><strong>CATEGORIAS</strong></p>
        </div>
