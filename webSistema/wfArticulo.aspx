<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfArticulo.aspx.vb" Inherits="webSistema.wfArticulo" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="text-center mt-4">
            <p style="font-size:40px;"><strong>ARTICULOS</strong></p>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12">
                    <div class="formulario p-3 rounded" style="background-color: #f9f9f9; border: 1px solid #ddd;">
                        ...
                        <div class="form-group mt-2" id="categoria">
                            <label for="ddlCategoria">Categoria (*)</label>
                            <asp:DropDownList ID="CboCategoria" runat="server" CssClass="form-control mt-2"></asp:DropDownList>
                        </div>
                
                        <div class="form-group mt-2" id="codigo">
                            <label for="txtcodigo">Código</label>
                            <asp:TextBox ID="TxtCodigo" runat="server" CssClass="form-control mt-2"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group mt-2" id="stock">
                            <label for="txtstock">Stock (*)</label>
                            <asp:TextBox ID="TxtStock" runat="server" CssClass="form-control mt-2"></asp:TextBox>
                        </div>

                        <div class="form-group mt-2" id="precioventa">
                            <label for="txtprecioventa">Precio Venta (*)</label>
                            <asp:TextBox ID="TxtPrecioVenta" runat="server" CssClass="form-control mt-2"></asp:TextBox>
                        </div>

                        <div class="form-group mt-2" id="descripcion">
                            <label for="txtdescripcion">Descripcion</label>
                            <asp:TextBox ID="TxtDescripcion" runat="server" CssClass="form-control mt-2" Height="62"></asp:TextBox>
                        </div>

                        <div class="form-group mt-2" id="imagen">
